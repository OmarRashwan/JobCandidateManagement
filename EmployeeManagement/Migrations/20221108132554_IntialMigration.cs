...
namespace JobCandidateManagement.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeTextComment = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Email", "FirstName", "FreeTextComment", "GitHubProfile", "LastName", "LinkedinProfile", "Phone", "TimeInterval" },
                values: new object[] { new Guid("72f2f5fe-e50c-4966-8420-d50258aefdcb"), "hh@em.com", "Megan", "test", "github", "Jones", "linked", "3", "333" });

            migrationBuilder.InsertData(
                table: "CandidateDetails",
                columns: new[] { "Id", "Email", "FirstName", "FreeTextComment", "GitHubProfile", "LastName", "LinkedinProfile", "Phone", "TimeInterval" },
                values: new object[] { new Guid("f484ad8f-78fd-46d1-9f87-bbb1e676e37f"), "hh@em.com", "Jaimy", "test", "github", "Johnson", "linked", "3", "333" });
        }
